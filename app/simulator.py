...
from app.expedition import EncounterType, Expedition
...
class DungeonSimulator:
    ...
    def advance_turn(self, expedition_id: int) -> dict[str, Any]:
        ...
        room_contents = expedition.determine_room_contents()
    ...
    def get_expedition_results(self, expedition_id: int) -> dict[str, Any]:
        ...
        results = {
            ...
            "treasure_silver": sum(t.get("silver", 0) for t in expedition.treasure),
            "treasure_copper": sum(t.get("copper", 0) for t in expedition.treasure),
